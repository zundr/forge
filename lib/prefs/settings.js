  ...
  constructor({ settings, window, metadata }) {
    ...
    this.add_group({
      ...
      children: [
        ...
        new SwitchRow({
          title: _("Condense redundant containers"),
          subtitle: _("Automatically flatten nested containers with same layout type"),
          experimental: true,
          settings,
          bind: "condense-redundant-containers",
        }),
        new SwitchRow({
        ...
        new SwitchRow({
          title: _("Group top-level windows in tabbed mode"),
          subtitle: _("When toggling tabbed mode, group all top-level sibling windows together"),
          settings,
          bind: "tabbed-tiling-mode-group-top-level",
        }),
        new SwitchRow({
        ...
        new SwitchRow({
          title: _("Show reorganize button in panel"),
          subtitle: _("Adds a button to the panel to reorganize windows by workspace rules"),
          settings,
          bind: "panel-reorganize-button-enabled",
        }),
      ],
    });
    this.add_group({
